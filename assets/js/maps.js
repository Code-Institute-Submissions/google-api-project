...
// Search for locations in the city selected
function search() {
    ...
    if (status === google.maps.places.PlacesServiceStatus.OK) {
      ...
      for (var i = 0; i < results.length; i++) {
        ...
        if (locations == "lodging") {
          ...
          image = "assets/images/temple-2.png";
        }
...
// Get the place details for a selected hotel in an info window.
